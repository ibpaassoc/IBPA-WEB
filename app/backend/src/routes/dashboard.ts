...
// `teamMemberEmails` rides along so the picker can offer an account's team without a
// per-owner round trip; the roster detail is still fetched on demand when expanded.
