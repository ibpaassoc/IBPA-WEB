...
const demoOrders: DemoOrderSeed[] = [
  {
    email: "demo.pending.student@ibpa.test",
    name: "Sofia Bennett",
    ...
    applicationPayload: {
      ...
      educationDesc: "Beauty school student focused on esthetics and brow artistry.",
      ...
      contributionDesc: "I can support future events and student initiatives.",
